<template>
  <div class="slack-logo-component">
    <svg
      version="1.1"
      id="Layer_1"
      ...
      style="enable-background:new 0 0 622.3 254.4;"
      xml:space="preserve"
    >
      <g>
        <g>
          ...
          ></path>
          <rect x="290.8" y="64.5" width="21.4" height="104.7"></rect>
          <polygon
            points="484.9,64.5 484.9,169.2 506.3,169.2 506.3,137.8 531.7,169.2 559.1,169.2 526.8,131.9 556.7,97.1 530.5,97.1
...
<script lang="ts">
import Vue from "vue";
export default Vue.extend({ name: "SlackLogo" });
</script>
